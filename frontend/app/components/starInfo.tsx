        ...
        <div className='bulma'>
          <div className='columns is-vcentered mx-4 mb-2'>
            ...
            <div className='column'>
              <h1 className='title is-size-5 mb-2'>{this.props.options.name}</h1>

              <div className='mb-2'>
                <ul>
                  <li>
                    <strong>X: </strong> {this.props.options.x}
                  </li>
                  <li>
                    <strong>Y: </strong> {this.props.options.y}
                  </li>
                  <li>
                    <strong>Zone: </strong> {this.props.options.zone}
                  </li>
                  <li>
                    <strong>Star ID: </strong> {this.props.options.id}
                  </li>
                  <li>
                    <strong>Net Influence: </strong> {this.props.options.influence}
                  </li>
                </ul>
              </div>
            </div>
