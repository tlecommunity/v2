...
YAHOO.tool.TestRunner = (function () {
  ...
  YAHOO.lang.extend(TestRunner, YAHOO.util.EventProvider, {
     ...
     */
    _addTestCaseToTestTree: function (
      parentNode /*:TestNode*/,
     ...
     */
    _addTestSuiteToTestTree: function (
      parentNode /*:TestNode*/,
    ...
    run: function (oldMode) {
      ...
      if (
        ...
        this.masterSuite.items[0] instanceof YAHOO.tool.TestSuite
      ) {
...
YAHOO.util.Assert = {
  ...
  areEqual: function (expected /*:Object*/, actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (expected != actual) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Values should be equal.'),
        expected,
        actual
      );
    }
  ...
  areNotEqual: function (
    ...
    if (unexpected == actual) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Values should not be equal.'),
        unexpected
      );
    }
  },
  ...
  areNotSame: function (unexpected /*:Object*/, actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (unexpected === actual) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Values should not be the same.'),
        unexpected
      );
    }
  },
  ...
  areSame: function (expected /*:Object*/, actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (expected !== actual) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Values should be the same.'),
        expected,
        actual
      );
    }
  ...
  isFalse: function (actual /*:Boolean*/, message /*:String*/) {
    if (false !== actual) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be false.'),
        false,
        actual
      );
    }
  ...
  isTrue: function (actual /*:Boolean*/, message /*:String*/) /*:Void*/ {
    if (true !== actual) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be true.'),
        true,
        actual
      );
    }
  ...
  isNaN: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!isNaN(actual)) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be NaN.'),
        NaN,
        actual
      );
    }
  ...
  isNotNaN: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (isNaN(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Values should not be NaN.'),
        NaN
      );
    }
  },
  ...
  isNotNull: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (YAHOO.lang.isNull(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Values should not be null.'),
        null
      );
    }
  },
  ...
  isNotUndefined: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (YAHOO.lang.isUndefined(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should not be undefined.'),
        undefined
      );
    }
  },
  ...
  isNull: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isNull(actual)) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be null.'),
        null,
        actual
      );
    }
  ...
  isUndefined: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isUndefined(actual)) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be undefined.'),
        undefined,
        actual
      );
    }
  ...
  isArray: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isArray(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be an array.'),
        actual
      );
    }
  },
  ...
  isBoolean: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isBoolean(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be a Boolean.'),
        actual
      );
    }
  },
  ...
  isFunction: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isFunction(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be a function.'),
        actual
      );
    }
  },
  ...
  isInstanceOf: function (
    ...
    if (!(actual instanceof expected)) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, "Value isn't an instance of expected type."),
        expected,
        actual
      );
    }
  ...
  isNumber: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isNumber(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be a number.'),
        actual
      );
    }
  },
  ...
  isObject: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isObject(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be an object.'),
        actual
      );
    }
  },
  ...
  isString: function (actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (!YAHOO.lang.isString(actual)) {
      throw new YAHOO.util.UnexpectedValue(
        this._formatMessage(message, 'Value should be a string.'),
        actual
      );
    }
  },
  ...
  isTypeOf: function (expected /*:String*/, actual /*:Object*/, message /*:String*/) /*:Void*/ {
    if (typeof actual != expected) {
      throw new YAHOO.util.ComparisonFailure(
        this._formatMessage(message, 'Value should be of type ' + expected + '.'),
        expected,
        typeof actual
      );
    }
 ...
 * @constructor
 */
YAHOO.util.ComparisonFailure = function (
  message /*:String*/,
  expected /*:Object*/,
  actual /*:Object*/
) {
...
YAHOO.util.ShouldError = function (message /*:String*/) {
  //call superclass
  YAHOO.util.AssertionError.call(
    this,
...
YAHOO.util.ArrayAssert = {
  ...
  contains: function (needle /*:Object*/, haystack /*:Array*/, message /*:String*/) /*:Void*/ {
    ...
    if (!found) {
      Assert.fail(
        Assert._formatMessage(
          message,
          'Value ' + needle + ' (' + typeof needle + ') not found in array [' + haystack + '].'
        )
      );
    }
  },
    ...
    for (var i = 0; i < haystack.length; i++) {
      if (haystack[i] === needle) {
        YAHOO.util.Assert.areEqual(
          index,
          i,
          message || 'Value exists at index ' + i + ' but should be at index ' + index + '.'
        );
        return;
      }
    }
...
YAHOO.util.ObjectAssert = {
  ...
  hasProperty: function (
    ...
    if (!(propertyName in object)) {
      var Assert = YAHOO.util.Assert;
      Assert.fail(
        Assert._formatMessage(message, "Property '" + propertyName + "' not found on object.")
      );
    }
  },
  ...
  datesAreEqual: function (expected /*:Date*/, actual /*:Date*/, message /*:String*/) {
    if (expected instanceof Date && actual instanceof Date) {
      ...
      Assert.areEqual(
        ...
        actual.getFullYear(),
        Assert._formatMessage(message, 'Years should be equal.')
      );
      Assert.areEqual(
        expected.getMonth(),
        actual.getMonth(),
        Assert._formatMessage(message, 'Months should be equal.')
      );
      Assert.areEqual(
        expected.getDate(),
        actual.getDate(),
        Assert._formatMessage(message, 'Day of month should be equal.')
      );
    } else {
      throw new TypeError(
  ...
  timesAreEqual: function (expected /*:Date*/, actual /*:Date*/, message /*:String*/) {
    if (expected instanceof Date && actual instanceof Date) {
      ...
      Assert.areEqual(
        expected.getHours(),
        actual.getHours(),
        Assert._formatMessage(message, 'Hours should be equal.')
      );
      Assert.areEqual(
        expected.getMinutes(),
        actual.getMinutes(),
        Assert._formatMessage(message, 'Minutes should be equal.')
      );
      Assert.areEqual(
        expected.getSeconds(),
        actual.getSeconds(),
        Assert._formatMessage(message, 'Seconds should be equal.')
      );
    } else {
      throw new TypeError(
    ...
    function serializeToXML(results) {
      ...
      if (results.type == 'test') {
        ...
        for (var prop in results) {
          if (
            l.hasOwnProperty(results, prop) &&
            l.isObject(results[prop]) &&
            !l.isArray(results[prop])
          ) {
...
YAHOO.tool.TestReporter.prototype = {
  ...
  report: function (results /*:Object*/) /*:Void*/ {
    ...
    for (var prop in this._fields) {
      if (
        YAHOO.lang.hasOwnProperty(this._fields, prop) &&
        typeof this._fields[prop] != 'function'
      ) {
        if (YAHOO.env.ua.ie) {
