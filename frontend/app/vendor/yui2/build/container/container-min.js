...
(function () {
  ...
  var i = YAHOO.lang,
    ...
    l = {
      X: { key: 'x', validator: i.isNumber, suppressEvent: true, supercedes: ['iframe'] },
      Y: { key: 'y', validator: i.isNumber, suppressEvent: true, supercedes: ['iframe'] },
      XY: { key: 'xy', suppressEvent: true, supercedes: ['iframe'] },
      CONTEXT: { key: 'context', suppressEvent: true, supercedes: ['iframe'] },
      FIXED_CENTER: { key: 'fixedcenter', value: false, supercedes: ['iframe', 'visible'] },
      WIDTH: {
        key: 'width',
        suppressEvent: true,
      ...
      AUTO_FILL_HEIGHT: { key: 'autofillheight', supercedes: ['height'], value: 'body' },
            ...
            if (B != 'visible' || B === '' || this._fadingOut) {
              if (this.beforeShowEvent.fire()) {
                ...
                for (s = 0; s < z; s++) {
                  ...
                  if (
                    s === 0 &&
                    !y(q.animateInCompleteEvent, this.showEvent.fire, this.showEvent)
                  ) {
            ...
            if (f.isFunction(u.handler)) {
              ...
              if (f.isObject(u.handler) && f.isFunction(u.handler.fn)) {
                b.on(
                  ...
                  'click',
                  u.handler.fn,
                  !f.isUndefined(u.handler.obj) ? u.handler.obj : this,
...
(function () {
  ...
  a.FADE = function (d, f) {
    var g = YAHOO.util.Easing,
      i = { attributes: { opacity: { from: 0, to: 1 } }, duration: f, method: g.easeIn },
      e = { attributes: { opacity: { to: 0 } }, duration: f, method: g.easeOut },
  ...
  a.SLIDE = function (f, d) {
    var i = YAHOO.util.Easing,
      ...
      j = { attributes: { points: { to: [l, k] } }, duration: d, method: i.easeIn },
      e = { attributes: { points: { to: [m + 25, k] } }, duration: d, method: i.easeOut },
