    ...
    render: function (appendToNode, moduleElement) {
      ...
      if (appendToNode) {
        ...
        if (!Dom.inDocument(this.element)) {
          YAHOO.log(
            'Render failed. Must specify appendTo node if ' + " Module isn't already in the DOM.",
            'error'
          );
          return false;
        }
...
(function () {
  ...
  YAHOO.extend(Overlay, Module, {
          ...
          if (currentVis == 'visible' || this._fadingIn) {
            if (this.beforeHideEvent.fire()) {
              ...
              for (k = 0; k < nEffectInstances; k++) {
                ...
                if (
                  k === 0 &&
                  !alreadySubscribed(h.animateOutCompleteEvent, this.hideEvent.fire, this.hideEvent)
                ) {
    ...
    fitsInViewport: function () {
      ...
      return (
        elementWidth + nViewportOffset < viewportWidth &&
        elementHeight + nViewportOffset < viewportHeight
      );
    },
    ...
    _getConstrainedPos: function (pos, val) {
      var overlayEl = this.element,
        ...
        bPreventContextOverlap =
          ...
          context &&
          overlapPositions[context[1] + context[2]],
      ...
      if (val < minConstraint || val > maxConstraint) {
        if (bPreventContextOverlap) {
          constrainedVal = this._preventOverlap(
            pos,
            context[0],
            overlaySize,
            viewportSize,
    ...
    _preventOverlap: function (pos, contextEl, overlaySize, viewportSize, docScroll) {
      var x = pos == 'x',
        ...
        setPosition = function () {
          var displayRegionSize =
              overlay.cfg.getProperty(pos) - docScroll > contextElPos
                ? maxRegionSize
                : minRegionSize,
            position;
  ...
  OverlayManager.prototype = {
    ...
    _bindFocus: function (overlay) {
      ...
      if (!overlay.focus) {
        Event.on(
          overlay.element,
          mgr.cfg.getProperty('focusevent'),
          mgr._onOverlayElementFocus,
          null,
          overlay
        );
...
(function () {
  ...
  function setWidthToOffsetWidth(p_sType, p_aArgs) {
    ...
    if (
      (!sOriginalWidth || sOriginalWidth == 'auto') &&
  ...
  YAHOO.extend(Tooltip, YAHOO.widget.Overlay, {
    ...
    onContextMouseOver: function (e, obj) {
      ...
      if (
        obj.fireEvent('contextMouseOver', context, e) !== false &&
    ...
    doShow: function (e, context) {
      ...
      if (UA.opera && context.tagName && context.tagName.toUpperCase() == 'A') {
        yOffset += 12;
      }
      ...
      return setTimeout(function () {
        ...
        if (
          me._tempTitle &&
          (txt === '' || YAHOO.lang.isUndefined(txt) || YAHOO.lang.isNull(txt))
        ) {
...
(function () {
   ...
   * @type Array
   */
  Panel.FOCUSABLE = ['a', 'button', 'select', 'textarea', 'input', 'iframe'];
  ...
  function setWidthToOffsetWidth(p_sType, p_aArgs) {
    var oConfig, sOriginalWidth, sNewWidth;
  ...
  YAHOO.extend(Panel, Overlay, {
    ...
    _onElementFocus: function (e) {
      if (_currentModal === this) {
        ...
        if (
          ...
          target !== this.element &&
          target !== this.mask &&
          !Dom.isAncestor(this.element, target)
        ) {
          try {
    ...
    setTabLoop: function (firstElement, lastElement) {
      var backTab = this.preventBackTab,
  ...
  YAHOO.extend(Dialog, YAHOO.widget.Panel, {
    ...
    setFirstLastFocusable: function () {
      ...
      var i,
        l,
        el,
        elements = this.focusableElements;
    ...
    getData: function () {
      ...
      function isFormElement(p_oElement) {
        ...
        return (
          (sTag == 'INPUT' || sTag == 'TEXTAREA' || sTag == 'SELECT') && p_oElement.name == sName
        );
      }
                  ...
                  for (n = 0; n < nOptions; n++) {
                    ...
                    if (oOption.selected) {
                      ...
                      aValues[aValues.length] =
                        valueAttr && valueAttr.specified ? oOption.value : oOption.text;
                    }
                  }
                  oData[sName] = aValues;
                  break;
