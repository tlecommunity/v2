(function () {
  ...
  YAHOO.extend(TabView, Y.Element, {
    ...
    initAttributes: function (attr) {
       ...
       */
      this._tabParent =
        this.getElementsByClassName(this.TAB_PARENT_CLASSNAME, 'ul')[0] || this._createTabParent();
    ...
    _onActiveTabChange: function (e) {
      ...
      if (activeIndex !== newIndex) {
        if (!this.set(ACTIVE_INDEX, newIndex)) {
          // NOTE: setting
    ...
    _onActiveIndexChange: function (e) {
      ...
      if (e.newValue !== this.getTabIndex(this.get(ACTIVE_TAB))) {
        if (!this.set(ACTIVE_TAB, this.getTab(e.newValue))) {
          // NOTE: setting
      ...
      this.dataConnection = Y.Connect.asyncRequest(
        ...
        this.get(DATA_SRC),
        {
          success: function (o) {
            ...
            Dom.removeClass(this.get(CONTENT_EL).parentNode, this.LOADING_CLASSNAME);
            this._loading = false;
          },
          failure: function (o) {
