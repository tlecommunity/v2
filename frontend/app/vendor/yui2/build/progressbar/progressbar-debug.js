...
(function () {
  ...
  Lang.extend(Prog, YAHOO.util.Element, {
    ...
    initAttributes: function (oConfigs) {
      ...
      var key,
        presets = ['id', WIDTH, HEIGHT, 'class', 'style'];
      ...
      this.setAttributeConfig(VALUE, {
        ...
        validator: function (value) {
          return (
            Lang.isNumber(value) && value >= this.get(MIN_VALUE) && value <= this.get(MAX_VALUE)
          );
        },
    ...
    _fixEdges: function () {
      ...
      var maskEl = this.get(MASK_EL),
        ...
        newSize =
          parseInt(Dom.getStyle(maskEl, HEIGHT), 10) -
          parseInt(Dom.getStyle(tlEl, HEIGHT), 10) +
          PX;

      Dom.setStyle(blEl, HEIGHT, newSize);
      Dom.setStyle(brEl, HEIGHT, newSize);
      newSize =
        parseInt(Dom.getStyle(maskEl, WIDTH), 10) - parseInt(Dom.getStyle(tlEl, WIDTH), 10) + PX;
    ...
    _valueChange: function (value, noAnim) {
      ...
      if (this._rendered) {
        ...
        Prog._barSizeFunctions[noAnim !== false && anim ? 1 : 0][this.get(DIRECTION)].call(
          this,
          value,
          pixelValue,
          this.get(BAR_EL),
