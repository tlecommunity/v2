  ...
  YAHOO.extend(LayoutUnit, YAHOO.util.Element, {
          ...
          case 'bottom':
            ...
            if (this.get('position') == 'bottom') {
              Dom.setStyle(
                ...
                this._lastTop +
                  this._lastHeight -
                  (this.get('collapseSize') - this._gutter.top) +
                  'px'
              );
            } else {
              Dom.setStyle(this._clip, 'top', this.get('top') + this._gutter.top + 'px');
    ...
    initAttributes: function (attr) {
      ...
      this.setAttributeConfig('easing', {
        value:
          attr.easing || (YAHOO.util && YAHOO.util.Easing ? YAHOO.util.Easing.BounceIn : 'false'),
      });
      /**
       * @attribute animate
      ...
      this.setAttributeConfig('animate', {
        ...
        method: function (anim) {
          if (anim) {
            this._anim = new YAHOO.util.Anim(
              this.get('element'),
              {},
              this.get('duration'),
              this.get('easing')
      ...
      this.setAttributeConfig('collapse', {
        ...
        method: function (collapse) {
          ...
          var c = this.header
            ? Dom.getElementsByClassName('collapse', 'div', this.header)[0]
            : null;
      ...
      this.setAttributeConfig('scroll', {
        value:
          attr.scroll === true || attr.scroll === false || attr.scroll === null
            ? attr.scroll
            : false,
        ...
        method: function (resize) {
          if (resize && !this._resize) {
            ...
            if (handle) {
              ...
              this._resize._handles[handle].innerHTML =
