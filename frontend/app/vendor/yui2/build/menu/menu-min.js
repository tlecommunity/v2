      ...
      if (r && r.tagName) {
        switch (r.tagName.toUpperCase()) {
          case T:
            p = r.parentNode;
            if (
              (C.hasClass(r, P) || C.hasClass(r, M) || C.hasClass(r, O)) &&
              p &&
              p.tagName &&
              p.tagName.toUpperCase() == T
            ) {
              q = p;
            } else {
              q = r;
        ...
        if (w == U) {
          for (var v in o) {
            if (H.hasOwnProperty(o, v)) {
              ...
              if (
                y.cfg.getProperty(L) &&
                !(y instanceof YAHOO.widget.MenuBar) &&
                y.cfg.getProperty(S) == Q
              ) {
                y.hide();
...
(function () {
  ...
  var f = YAHOO.util.Dom,
    ...
    AZ = { key: Au, value: false, validator: AM.isBoolean },
    AP = { key: w, value: true, validator: AM.isBoolean, supercedes: [AF, 'x', R, e] },
    AI = { key: A4, value: true, validator: AM.isBoolean, supercedes: [w] },
    S = { key: Ac, value: AD, validator: B, supercedes: [Au, AF] },
    A = { key: AO, value: ['tl', 'tr'] },
    t = { key: Z, value: true, validator: AM.isBoolean, suppressEvent: true },
    Y = { key: Av, value: 250, validator: AM.isNumber, suppressEvent: true },
    q = { key: AX, value: 0, validator: AM.isNumber, suppressEvent: true },
    v = { key: c, value: 250, validator: AM.isNumber, suppressEvent: true },
    o = { key: AC, value: true, validator: AM.isBoolean, suppressEvent: true },
    AN = { key: g, suppressEvent: true },
    Af = { key: j, value: 1, validator: AM.isNumber, supercedes: [AU], suppressEvent: true },
    N = { key: Aj, value: 90, validator: AM.isNumber, supercedes: [AU], suppressEvent: true },
    X = { key: AU, value: 0, validator: AM.isNumber, supercedes: [AF], suppressEvent: true },
    W = { key: A2, value: null, validator: AM.isString, suppressEvent: true },
    a = { key: Ah, value: false, validator: AM.isBoolean, suppressEvent: true },
    I = { key: Ag, value: true, validator: AM.isBoolean, suppressEvent: true, supercedes: [Au] },
    Al = { key: Ar, value: false, validator: AM.isBoolean };
  function Aa(A5) {
    Ad = AA.getTarget(A5);
  }
  YAHOO.lang.extend(r, AB, {
    ...
    _onMouseOver: function (BH, BA) {
      ...
      if (!this._bStopMouseEventHandlers) {
        if (
          ...
          (A5 == this.element || f.isAncestor(this.element, A5))
        ) {
        ...
        if (
          BE &&
          !BE.handledMouseOverEvent &&
          !BE.cfg.getProperty(Ah) &&
          (A5 == BE.element || f.isAncestor(BE.element, A5))
        ) {
    ...
    _onMouseOut: function (BD, A7) {
      ...
      if (!this._bStopMouseEventHandlers) {
        if (BB && !BB.cfg.getProperty(Ah)) {
          ...
          if (
            !BB.handledMouseOutEvent &&
            ((A8 != BB.element && !f.isAncestor(BB.element, A8)) || BC)
          ) {
            if (!BC) {
    ...
    _onInit: function (A6, A5) {
      ...
      if (
        ((A7 && !A8) ||
          (A7 && (this.cfg.getProperty(Au) || this.cfg.getProperty(Ac) == C)) ||
          (!A7 && !A8)) &&
      ...
      if (this.lazyLoad && this.getItemGroups().length === 0) {
        ...
        if (this.itemData) {
          if (
            ...
            this.parent.parent.srcElement.tagName.toUpperCase() == AH
          ) {
    ...
    getConstrainedY: function (BH) {
      var BS = this,
        ...
        BR,
        BG = { trbr: true, tlbl: true, bltl: true, brtr: true },
        BA = BO && BG[BO[1] + BO[2]],
        BC = BS.element,
        BW = BC.offsetHeight,
    ...
    _onShow: function (BD, BB) {
      ...
      if (A5) {
        A7 = A5.parent;
        if (
          !A7.cfg.getProperty(Z) &&
          (A7 instanceof YAHOO.widget.MenuBar || A7.cfg.getProperty(Ac) == C)
        ) {
        ...
        if (
          this.cfg.getProperty('x') < A7.cfg.getProperty('x') &&
          As.gecko &&
          As.gecko < 1.9 &&
...
(function () {
  ...
  var x = YAHOO.util.Dom,
    ...
    AP = { key: A, value: false, validator: AQ.isBoolean, suppressEvent: true, supercedes: [AL] },
    d = { key: N, value: false, validator: AQ.isBoolean, suppressEvent: true, supercedes: [AL] },
    l = { key: b, value: false, validator: AQ.isBoolean, suppressEvent: true, supercedes: [H, B] },
  ...
  c.prototype = {
    ...
    getNextEnabledSibling: function () {
      ...
      return AR.cfg.getProperty(H) || AR.element.style.display == t
