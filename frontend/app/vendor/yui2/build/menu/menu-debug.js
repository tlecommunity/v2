  ...
  YAHOO.widget.MenuManager = (function () {
      ...
      if (oMenu) {
        ...
        for (var i in m_oVisibleMenus) {
          if (Lang.hasOwnProperty(m_oVisibleMenus, i)) {
            ...
            if (
              oMenu.cfg.getProperty(_CLICK_TO_HIDE) &&
    ...
    function onMenuVisibleConfigChange(p_sType, p_aArgs) {
      ...
      if (bVisible) {
        ...
        YAHOO.log(this + ' added to the collection of visible menus.', 'info', _MENUMANAGER);
      } else if (m_oVisibleMenus[sId]) {
        delete m_oVisibleMenus[sId];

        YAHOO.log(this + ' removed from the collection of visible menus.', 'info', _MENUMANAGER);
      }
    }
        ...
        if (p_oMenu) {
          ...
          if (sId in m_oMenus && m_oMenus[sId] == p_oMenu) {
            ...
            if (sId in m_oVisibleMenus && m_oVisibleMenus[sId] == p_oMenu) {
              ...
              YAHOO.log(
                p_oMenu + ' unregistered from the' + ' collection of visible menus.',
                'info',
                _MENUMANAGER
              );
            }
...
(function () {
  ...
  YAHOO.lang.extend(Menu, Overlay, {
        ...
        if (sSrcElementTagName) {
          switch (sSrcElementTagName) {
            case _DIV_UPPERCASE:
              ...
              if (nListElements > 0) {
                YAHOO.log(
                  'Found ' + nListElements + ' item groups to initialize.',
                  'info',
                  this.toString()
                );
        ...
        if (Lang.isNumber(p_nItemIndex)) {
          ...
          if (oGroupItem) {
            ...
            YAHOO.log(
              'Item inserted.' +
                ' Text: ' +
                oGroupItem.cfg.getProperty('text') +
                ', ' +
                ' Index: ' +
                oGroupItem.index +
                ', ' +
                ' Group Index: ' +
                oGroupItem.groupIndex,
              'info',
              this.toString()
            );
      ...
      if (!this._bStopMouseEventHandlers) {
        ...
        if (
          ...
          if (this.cfg.getProperty(_AUTO_SUBMENU_DISPLAY)) {
            ...
            if (oSubmenu) {
              if (bShowDelay) {
                oRoot._showDelayTimer = Lang.later(
                  oRoot.cfg.getProperty(_SHOW_DELAY),
                  oSubmenu,
                  showSubmenu
                );
              } else {
      ...
      if (!this._bStopMouseEventHandlers) {
        if (oItem && !oItem.cfg.getProperty(_DISABLED)) {
          ...
          if (
            ...
            ((oRelatedTarget != oItem.element && !Dom.isAncestor(oItem.element, oRelatedTarget)) ||
              bMovingToSubmenu)
          ) {
            if (!bMovingToSubmenu) {
        ...
        YAHOO.log(
          'onMouseout: Ancestorthis.element = ' + Dom.isAncestor(this.element, oRelatedTarget)
        );
    ...
    _didMouseLeave: function (oRelatedTarget) {
      ...
      return (
        oRelatedTarget === this._shadow ||
        (oRelatedTarget != this.element && !Dom.isAncestor(this.element, oRelatedTarget))
      );
    },
    ...
    _onClick: function (p_sType, p_aArgs) {
      ...
      var hide = function () {
        ...
        if (oRoot instanceof YAHOO.widget.MenuBar || oRoot.cfg.getProperty(_POSITION) == _STATIC) {
          oRoot.clearActiveItem();
        } else {
          oRoot.hide();
        }
          ...
          if (sURL) {
            ...
            if (nHashPos != -1) {
              ...
              if (nLen > 1) {
                ...
                if (oMenu) {
                  bInMenuAnchor = this.getRoot() === oMenu.getRoot();
                }
              } else if (nLen === 1) {
                bInMenuAnchor = true;
              }
...
*/
        ...
        switch (oEvent.keyCode) {
          ...
          case 40: // Down arrow
            ...
            if (oNextItem) {
              ...
              if (
                this.cfg.getProperty(_MAX_HEIGHT) > 0 ||
                Dom.hasClass(this.body, _YUI_MENU_BODY_SCROLLED)
              ) {
                oBody = this.body;
    ...
    */
      ...
      if (
        ((bRootMenu && !bLazyLoad) ||
          (bRootMenu &&
            (this.cfg.getProperty(_VISIBLE) || this.cfg.getProperty(_POSITION) == _STATIC)) ||
          (!bRootMenu && !bLazyLoad)) &&
    ...
    getConstrainedY: function (y) {
      ...
      var flipVertical = function () {
        ...
        if (oMenu.cfg.getProperty(_Y) - scrollY > nContextElY) {
          ...
          // The Menu is above the context element, flip it below
    ...
    */
      ...
      var getDisplayRegionHeight = function () {
        ...
        if (oMenu.cfg.getProperty(_Y) - scrollY > nContextElY) {
          ...
          // The Menu is above the context element
    ...
    */
      ...
      var setVerticalPosition = function () {
        ...
        if (nMenuOffsetHeight > nDisplayRegionHeight) {
          nMenuMinScrollHeight = bMenuHasItems
    ...
    _onShow: function (p_sType, p_aArgs) {
      ...
      if (oParent) {
        ...
        if (
          this.cfg.getProperty('x') < oParentMenu.cfg.getProperty('x') &&
          UA.gecko &&
          UA.gecko < 1.9 &&
    ...
    */
    ...
    _setScrollHeight: function (p_nScrollHeight) {
      ...
      if (this.getItems().length > 0) {
        ...
        if (nScrollHeight > 0 && bSetWidth && !this.cfg.getProperty(_WIDTH)) {
          ...
          YAHOO.log(
            'Setting the "width" configuration property to ' + sWidth + ' for srolling.',
            'info',
            this.toString()
          );
        ...
        if (nHeight > 0 && oBody.offsetHeight > nScrollHeight) {
          YAHOO.log('Setting up styles and event handlers for scrolling.', 'info', this.toString());
    ...
    setItemGroupTitle: function (p_sGroupTitle, p_nGroupIndex) {
      ...
      if (Lang.isString(p_sGroupTitle) && p_sGroupTitle.length > 0) {
        ...
        if (nFirstIndex !== null) {
          Dom.addClass(this._aGroupTitleElements[nFirstIndex], _FIRST_OF_TYPE);
        }
    ...
    */
       ...
       * @type Boolean
       */
      oConfig.addProperty(CONSTRAIN_TO_VIEWPORT_CONFIG.key, {
    ...
    */
       ...
       * @type Array
       */
      oConfig.addProperty(SUBMENU_ALIGNMENT_CONFIG.key, {
       ...
       * @type Boolean
       */
      oConfig.addProperty(AUTO_SUBMENU_DISPLAY_CONFIG.key, {
       ...
       * @type Number
       */
      oConfig.addProperty(SUBMENU_HIDE_DELAY_CONFIG.key, {
       ...
       * @type Boolean
       */
      oConfig.addProperty(CLICK_TO_HIDE_CONFIG.key, {
       ...
       * @type Number
       */
      oConfig.addProperty(SCROLL_INCREMENT_CONFIG.key, {
       ...
       * @type Number
       */
      oConfig.addProperty(MIN_SCROLL_HEIGHT_CONFIG.key, {
       ...
       * @type Number
       */
      oConfig.addProperty(MAX_HEIGHT_CONFIG.key, {
...
(function () {
  ...
  MenuItem.prototype = {
    ...
    _initSubTree: function () {
      ...
      if (oSrcEl.childNodes.length > 0) {
        if (
          ...
          oConfig.setProperty(_SUBMENU, { id: Dom.generateId(), itemdata: oSrcEl.childNodes });
        } else {
    ...
    configOnClick: function (p_sType, p_aArgs, p_oItem) {
      ...
      if (!this._oOnclickAttributeValue && Lang.isObject(oObject) && Lang.isFunction(oObject.fn)) {
    ...
    _createKeyListener: function (type, args, keyData) {
      ...
      var oKeyListener = new YAHOO.util.KeyListener(oMenu.element.ownerDocument, keyData, {
    ...
    configKeyListener: function (p_sType, p_aArgs) {
      ...
      if (oMenuItem._keyData) {
        ...
        oMenu.unsubscribe(_SHOW, oMenuItem._createKeyListener, oMenuItem._keyData);
      ...
      if (oKeyData) {
        ...
        oMenu.subscribe(_SHOW, oMenuItem._createKeyListener, oKeyData, oMenuItem);
      }
    },
    ...
    getNextEnabledSibling: function () {
      ...
      return next.cfg.getProperty(_DISABLED) || next.element.style.display == _NONE
        ? next.getNextEnabledSibling()
        : next;
    },
    ...
    getPreviousEnabledSibling: function () {
      ...
      return next.cfg.getProperty(_DISABLED) || next.element.style.display == _NONE
        ? next.getPreviousEnabledSibling()
        : next;
    },
    ...
    focus: function () {
      ...
      if (
        !this.cfg.getProperty(_DISABLED) &&
        oParent &&
...
(function () {
  ...
  Lang.extend(MenuBar, YAHOO.widget.Menu, {
    ...
    */
       ...
       * @type Boolean
       */
      oConfig.addProperty(SUBMENU_TOGGLE_REGION_CONFIG.key, {
