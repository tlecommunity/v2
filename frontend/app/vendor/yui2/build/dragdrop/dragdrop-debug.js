    ...
    return {
      ...
      handleMouseUp: function (e) {
        if (this.dragCurrent) {
          ...
          if (this.dragThreshMet) {
            ...
            if (this.fromTimeout) {
              YAHOO.log(
                "fromTimeout is true (mouse didn't move), call handleMouseMove so we can get the dragOver event",
                'info',
                'DragDropMgr'
              );
      ...
      fireEvents: function (e, isDrop) {
        ...
        var x = YAHOO.util.Event.getPageX(e),
          ...
          curRegion = new YAHOO.util.Region(
            pos.y,
          ...
          for (var i = 0; i < len; ++i) {
            ...
            if (this.mode == this.INTERSECT && dd.cursorIsOver) {
              ...
              if (
                !winner ||
                !winner.overlap ||
                (dd.overlap && winner.overlap.getArea() < dd.overlap.getArea())
              ) {
                winner = dd;
              }
            }
...
(function () {
  ...
  YAHOO.util.DragDrop.prototype = {
    ...
    initTarget: function (id, sGroup, config) {
      ...
      this.logger = YAHOO.widget.LogWriter ? new YAHOO.widget.LogWriter(this.toString()) : YAHOO;
    ...
    setInitPosition: function (diffX, diffY) {
      ...
      if (!this.DDM.verifyEl(el)) {
        if (el && el.style && el.style.display == 'none') {
          this.logger.log(
            this.id + ' can not get initial position, element style is display: none'
          );
        } else {
      ...
      this.logger.log(this.id + ' initial position: ' + this.initPageX + ', ' + this.initPageY);
    ...
    setXConstraint: function (iLeft, iRight, iTickSize) {
      ...
      this.logger.log('initPageX:' + this.initPageX + ' minX:' + this.minX + ' maxX:' + this.maxX);
    },
    ...
    setYConstraint: function (iUp, iDown, iTickSize) {
      ...
      this.logger.log('initPageY:' + this.initPageY + ' minY:' + this.minY + ' maxY:' + this.maxY);
    },
