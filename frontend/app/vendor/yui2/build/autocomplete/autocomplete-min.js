  ...
  if (g && b && j) {
    ...
    if (j._aDeprecatedSchema) {
      ...
      if (YAHOO.lang.isArray(k)) {
        if (
          j.responseType === YAHOO.util.DataSourceBase.TYPE_JSON ||
    ...
    if (YAHOO.util.Dom.inDocument(g)) {
      if (YAHOO.lang.isString(g)) {
        ...
        this._sName = g.id
          ? 'instance' + YAHOO.widget.AutoComplete._nIndex + ' ' + g.id
  ...
  if (l && l !== '') {
    ...
    for (var d = 0, h = c.length; d < h; d++) {
      ...
      if (YAHOO.lang.isString(e)) {
        var g = k
          ? e.indexOf(decodeURIComponent(l))
          : e.toLowerCase().indexOf(decodeURIComponent(l).toLowerCase());
        if ((!a && g === 0) || (a && g > -1)) {
          o.push(f);
        }
      }
  ...
  if (h && !f.error) {
    ...
    if (this._bFocused) {
      ...
      var u = f.results,
        ...
        m = this.dataSource.responseSchema.fields
...
YAHOO.widget.AutoComplete.prototype._toggleContainer = function (i) {
  ...
  if (a && a.getEl() && (this.animHoriz || this.animVert)) {
    ...
    a.attributes = i
      ? { width: { to: f }, height: { to: c } }
      : { width: { to: b }, height: { to: e } };
