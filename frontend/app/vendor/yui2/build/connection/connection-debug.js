  ...
  initCustomEvents: function (o, callback) {
    ...
    for (prop in callback.customevents) {
      if (this._customEvents[prop][0]) {
        ...
        YAHOO.log(
          'Transaction-specific Custom Event ' + o[this._customEvents[prop][1]] + ' created.',
          'info',
          'Connection'
        );
        ...
        YAHOO.log(
          'Transaction-specific Custom Event ' + o[this._customEvents[prop][1]] + ' subscribed.',
          'info',
          'Connection'
        );
      }
        ...
        case 13030: // See above comments for variable status.
          ...
          if (callback && callback.failure) {
            if (!callback.scope) {
              ...
              YAHOO.log(
                'Failure callback. Exception detected. Status code is ' + httpStatus,
                'warn',
                'Connection'
              );
            } else {
              ...
              YAHOO.log(
                'Failure callback with scope. Exception detected. Status code is ' + httpStatus,
                'warn',
                'Connection'
              );
            }
        ...
        default:
          ...
          if (callback && callback.failure) {
            if (!callback.scope) {
              ...
              callback.failure.apply(callback.scope, [responseObject]);
              YAHOO.log(
                'Failure callback with scope. HTTP status code is ' + httpStatus,
                'warn',
                'Connection'
              );
            }
  ...
  createResponseObject: function (o, callbackArg) {
    ...
    try {
      ...
      for (i = 0; i < header.length; i++) {
        ...
        if (delimitPos != -1) {
          headerObj[header[i].substring(0, delimitPos)] = YAHOO.lang.trim(
    ...
    if (this._has_default_headers) {
      for (prop in this._default_headers) {
        if (YAHOO.lang.hasOwnProperty(this._default_headers, prop)) {
          ...
          YAHOO.log(
            'Default HTTP header ' + prop + ' set with value of ' + this._default_headers[prop],
            'info',
            'Connection'
          );
        }
    ...
    if (this._has_http_headers) {
      for (prop in this._http_headers) {
        if (YAHOO.lang.hasOwnProperty(this._http_headers, prop)) {
          ...
          YAHOO.log(
            'HTTP header ' + prop + ' set with value of ' + this._http_headers[prop],
            'info',
            'Connection'
          );
        }
...
(function () {
  ...
  function _setForm(formId, isUpload, secureUri) {
    ...
    YAHOO.log(
      'Form initialized for transaction. HTML form POST message is: ' + this._sFormData,
      'info',
      'Connection'
    );
