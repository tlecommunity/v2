              ...
              if (YAHOO.lang.hasOwnProperty(currentSeries, prop)) {
                if (prop == 'style') {
                  ...
                  if (currentSeries.labelFunction !== null) {
                    clonedSeries.labelFunction = YAHOO.widget.Chart.getFunctionReference(
                      currentSeries.labelFunction
                    );
                    this._seriesFunctions.push(clonedSeries.labelFunction);
                  }
                } else if (prop == 'dataTipFunction') {
                  if (currentSeries.dataTipFunction !== null) {
                    clonedSeries.dataTipFunction = YAHOO.widget.Chart.getFunctionReference(
                      currentSeries.dataTipFunction
                    );
                  ...
                  if (currentSeries.legendLabelFunction !== null) {
                    clonedSeries.legendLabelFunction = YAHOO.widget.Chart.getFunctionReference(
                      currentSeries.legendLabelFunction
                    );
...
YAHOO.widget.PieChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.PieChart.superclass.constructor.call(
    this,
    'pie',
    containerId,
    dataSource,
...
YAHOO.widget.CartesianChart = function (type, containerId, dataSource, attributes) {
  YAHOO.widget.CartesianChart.superclass.constructor.call(
    this,
    type,
    containerId,
    dataSource,
...
YAHOO.lang.extend(YAHOO.widget.CartesianChart, YAHOO.widget.Chart, {
  ...
  setSeriesStylesByIndex: function (index, style) {
    ...
    if (this._swf && this._swf.setSeriesStylesByIndex)
      this._swf.setSeriesStylesByIndex(index, style);
  },
});
/**
...
YAHOO.widget.LineChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.LineChart.superclass.constructor.call(
    this,
    'line',
    containerId,
    dataSource,
...
YAHOO.widget.ColumnChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.ColumnChart.superclass.constructor.call(
    this,
    'column',
    containerId,
    dataSource,
...
YAHOO.widget.BarChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.BarChart.superclass.constructor.call(
    this,
    'bar',
    containerId,
    dataSource,
...
YAHOO.widget.StackedColumnChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.StackedColumnChart.superclass.constructor.call(
    this,
    'stackcolumn',
    containerId,
    dataSource,
...
YAHOO.widget.StackedBarChart = function (containerId, dataSource, attributes) {
  YAHOO.widget.StackedBarChart.superclass.constructor.call(
    this,
    'stackbar',
    containerId,
    dataSource,
