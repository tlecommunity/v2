...
if (YAHOO.util.DDProxy) {
  YAHOO.extend(YAHOO.widget.ColumnDD, YAHOO.util.DDProxy, {
    initConstraints: function () {
      var g = YAHOO.util.Dom.getRegion(this.table),
        d = this.getEl(),
        f = YAHOO.util.Dom.getXY(d),
        c = parseInt(YAHOO.util.Dom.getStyle(d, 'width'), 10),
        a = parseInt(YAHOO.util.Dom.getStyle(d, 'height'), 10),
        e = f[0] - g.left + 15,
        b = g.right - f[0] - c + 15;
    ...
    _resizeProxy: function () {
      ...
      YAHOO.util.Dom.setStyle(
        a,
        'width',
        parseInt(YAHOO.util.Dom.getStyle(a, 'width'), 10) + 4 + 'px'
      );
    ...
    onDragOver: function (h, a) {
      ...
      if (f) {
        ...
        if (c !== null) {
          var b = f.getThEl();
          var k = c;
          var d = YAHOO.util.Event.getPageX(h),
            i = YAHOO.util.Dom.getX(b),
            j = i + YAHOO.util.Dom.get(b).offsetWidth / 2,
            e = this.column.getTreeIndex();
          if (d < j) {
...
if (YAHOO.util.DD) {
  YAHOO.extend(YAHOO.util.ColumnResizer, YAHOO.util.DDProxy, {
    ...
    onMouseUp: function (h) {
      var f = this.datatable.getColumnSet().keys,
        b;
      ...
      var g =
        d.offsetWidth -
        (parseInt(YAHOO.util.Dom.getStyle(d, 'paddingLeft'), 10) | 0) -
        (parseInt(YAHOO.util.Dom.getStyle(d, 'paddingRight'), 10) | 0);
    ...
    startDrag: function () {
      var e = this.datatable.getColumnSet().keys,
        d = this.column.getKeyIndex(),
        b;
...
(function () {
  ...
  h.augmentObject(d, {
    ...
    formatDate: function (j, l, m, o, n) {
      var i = n || this,
        k = m.dateOptions || i.get('dateOptions');
      j.innerHTML = a.Date.format(o, k, k.locale);
    },
    formatDropdown: function (l, u, q, j, t) {
      var s = t || this,
        r = h.isValue(j) ? j : u.getData(q.field),
        v = h.isArray(q.dropdownOptions) ? q.dropdownOptions : null,
        k,
        p = l.getElementsByTagName('select');
      if (p.length === 0) {
    ...
    formatTextarea: function (j, k, m, o, n) {
      var l = h.isValue(o) ? h.escapeHTML(o.toString()) : '',
        i = '<textarea>' + l + '</textarea>';
      j.innerHTML = i;
    },
    formatTextbox: function (j, k, m, o, n) {
      var l = h.isValue(o) ? h.escapeHTML(o.toString()) : '',
        i = '<input type="text" value="' + l + '" />';
      j.innerHTML = i;
    },
  ...
  h.extend(d, a.Element, {
      ...
      this.setAttributeConfig('generateRequest', {
        value: function (k, n) {
          ...
          var m = encodeURIComponent(
            k.sortedBy ? k.sortedBy.key : n.getColumnSet().keys[0].getKey()
          );
          var j =
            k.sortedBy && k.sortedBy.dir === YAHOO.widget.DataTable.CLASS_DESC ? 'desc' : 'asc';
          var o = k.pagination ? k.pagination.recordOffset : 0;
          var l = k.pagination ? k.pagination.rowsPerPage : null;
          return (
            'sort=' + m + '&dir=' + j + '&startIndex=' + o + (l !== null ? '&results=' + l : '')
          );
        },
    ...
    _initColumnSet: function (n) {
      ...
      if (this._oColumnSet) {
        for (k = 0, j = this._oColumnSet.keys.length; k < j; k++) {
          ...
          d._oDynStyles['.' + this.getId() + '-col-' + m.getSanitizedKey() + ' .' + d.CLASS_LINER] =
            undefined;
    ...
    _reorderColgroupColEl: function (l, k) {
      if (
        ...
        h.isNumber(k) &&
        this._elColgroup &&
        this._elColgroup.childNodes.length > l[l.length - 1]
      ) {
        var j,
          n = [];
    ...
    _initTheadEl: function (v) {
      ...
      if (v) {
        ...
        var q = this._elColgroup
          ? v.insertBefore(document.createElement('thead'), this._elColgroup.nextSibling)
          : v.appendChild(document.createElement('thead'));
    ...
    formatTheadCell: function (i, m, k) {
      ...
      if (m.sortable) {
        ...
        i.innerHTML =
          '<a href="' + l + '" title="' + o + '" class="' + d.CLASS_SORTABLE + '">' + p + '</a>';
      } else {
        i.innerHTML = p;
      }
    },
        ...
        if (j._oCellEditor) {
          if (j._oCellEditor.getContainerEl) {
            ...
            if (j._oCellEditor.isActive) {
              if (
                !c.isAncestor(j._oCellEditor.container, m) &&
                j._oCellEditor.container.id !== m.id
              ) {
    ...
    getTdEl: function (i) {
      ...
      if (l && l.ownerDocument == document) {
        ...
        if (
          n &&
          (n.parentNode.parentNode == this._elTbody ||
            n.parentNode.parentNode === null ||
            n.parentNode.parentNode.nodeType === 11)
        ) {
          return n;
        }
      } else {
    ...
    getTrIndex: function (m) {
      var i = this.getRecord(m),
        k = this.getRecordIndex(i),
        l;
      if (i) {
        l = this.getTrEl(i);
        if (l) {
    ...
    load: function (i) {
      i = i || {};
      (i.datasource || this._oDataSource).sendRequest(
        i.request || this.get('initialRequest'),
        i.callback || {
    ...
    render: function () {
      ...
      var r,
        ...
        o,
        s,
        l = this._getViewRecords();
      var m = this._elTbody,
        q = this.get('renderLoopSize'),
        t = l.length;
      if (t > 0) {
      ...
      if (m && m instanceof YAHOO.widget.Column) {
        ...
        if (p) {
          if (this.get('dynamicData')) {
            ...
            var i =
              m.sortOptions && h.isFunction(m.sortOptions.sortFunction)
                ? m.sortOptions.sortFunction
                : null;
            if (!t || j || i) {
    ...
    validateColumnWidths: function (o) {
      ...
      if (o && !o.hidden && !o.width && o.getKeyIndex() !== null) {
        ...
        if (o.minWidth > 0 && k.offsetWidth < o.minWidth) {
          q.childNodes[o.getKeyIndex()].style.width =
            o.minWidth +
            (parseInt(c.getStyle(k, 'paddingLeft'), 10) | 0) +
            (parseInt(c.getStyle(k, 'paddingRight'), 10) | 0) +
            'px';
          p = true;
        } else {
      ...
      if (p) {
        ...
        if (m !== null) {
          ...
          if (q !== null) {
            ...
            if (t.length > 0) {
              var n = this.get('renderLoopSize'),
                l = t.length;
              this._oChainRender.add({
                method: function (y) {
                  if (this instanceof d && this._sId) {
                    var x = y.nCurrentRow,
                      v = n > 0 ? Math.min(x + n, t.length) : t.length,
                      z = y.aIndexes,
                      w;
                    for (; x < v; ++x) {
      ...
      if (w.length > 0) {
        ...
        if (v.length > 0) {
          ...
          for (p = 0, t = w.length; p < t; p++) {
            ...
            q = this._formatTdEl(
              this._oColumnSet.keys[j],
              q,
              j,
              j === this._oColumnSet.keys.length - 1
            );
            k[j] = q;
          }
          this._oChainRender.add({
            method: function (D) {
              if (this instanceof d && this._sId) {
                var C = D.nCurrentRow,
                  B,
                  F = D.descKeyIndexes,
                  A = o > 0 ? Math.min(C + o, v.length) : v.length,
                  E;
                for (; C < A; ++C) {
                ...
                method: function (D) {
                  if (this instanceof d && this._sId) {
                    var C = D.nCurrentRow,
                      ...
                      F,
                      E,
                      A = o > 0 ? Math.min(C + o, u.length) : u.length,
                      H = D.aIndexes,
                      G;
                    for (; C < A; ++C) {
                      F = [];
          ...
          i.add({
            method: function (m) {
              if (
                ...
                this._sId &&
                j[m.rowIndex] &&
                j[m.rowIndex].cells[m.cellIndex]
              ) {
            ...
            scope: this,
            iterations: j.length,
            argument: { rowIndex: 0, cellIndex: k.getKeyIndex() },
          });
          this._clearTrTemplateEl();
          this._elTbody.style.display = 'none';
          this._runRenderChain();
        ...
        j.add({
          method: function (n) {
            if (
              ...
              this._sId &&
              k[n.rowIndex] &&
              k[n.rowIndex].cells[n.cellIndex]
            ) {
    ...
    updateRow: function (u, k) {
      ...
      if (h.isNumber(r) && r >= 0) {
        var s = this._oRecordSet,
          q = s.getRecord(r);
        if (q) {
          var o = this._oRecordSet.setRecord(k, r),
            j = this.getTrEl(q),
            p = q ? q.getData() : null;
          if (o) {
            ...
            this._oChainRender.add({
              method: function () {
                if (this instanceof d && this._sId) {
                  ...
                  if (v) {
                    var i = v.getPageRecords()[0],
                      w = v.getPageRecords()[1];
                    if (r >= i || r <= w) {
                      this.render();
                    }
                  } else {
      ...
      if (h.isArray(m)) {
        ...
        if (h.isNumber(s) && s >= 0 && s < l.getLength()) {
          ...
          if (G) {
            ...
            if (F) {
              var r = F.getPageRecords()[0],
                p = F.getPageRecords()[1];
              if (s >= r || E <= p) {
                this.render();
              }
    ...
    deleteRows: function (y, s) {
      ...
      if (h.isNumber(l)) {
        ...
        if (z) {
          ...
          if (p) {
            var v = this.get('paginator'),
              r = this.get('renderLoopSize');
            if (v) {
              var t = v.get('totalRecords'),
                k = v.getPageRecords();
    ...
    formatCell: function (j, l, m) {
      ...
      if (l && m) {
        ...
        var n = l.getData(i);
        var k =
          typeof m.formatter === 'function'
            ? m.formatter
            : d.Formatter[m.formatter + ''] || d.Formatter.defaultFormatter;
        if (k) {
          k.call(this, j, l, m, n);
        } else {
          j.innerHTML = n;
    ...
    _handlePaginatorChange: function (l) {
      ...
      var n = l.newValue,
        m = l.prevValue,
        k = this._defaultPaginatorContainers();
      if (m) {
    ...
    _defaultPaginatorContainers: function (l) {
      var j = this._sId + '-paginator0',
        k = this._sId + '-paginator1',
        i = c.get(j),
        m = c.get(k);
      if (l && (!i || !m)) {
        if (!i) {
    ...
    isSelected: function (p) {
      if (p && p.ownerDocument == document) {
        return (
          c.hasClass(this.getTdEl(p), d.CLASS_SELECTED) ||
          c.hasClass(this.getTrEl(p), d.CLASS_SELECTED)
        );
      } else {
        var n, k, i;
        var m = this._aSelections;
        ...
        if (l && l.editor) {
          ...
          if (l.editor instanceof YAHOO.widget.BaseCellEditor) {
            ...
            if (q && l) {
              ...
              j.column = l;
              j.validator =
                l.editorOptions && h.isFunction(l.editorOptions.validator)
                  ? l.editorOptions.validator
                  : null;
              ...
              if (isNaN(o) || isNaN(m)) {
                ...
                m =
                  p.offsetTop +
                  c.getY(this._elTbody.parentNode) -
        ...
        if (this._oCellEditor.save) {
          ...
          if (this._oCellEditor.isActive) {
            ...
            if (this._oCellEditor.validator) {
              i = this._oCellEditor.value = this._oCellEditor.validator.call(
                this,
                i,
                j,
                this._oCellEditor
    ...
    onDataReturnReplaceRows: function (m, l, n) {
      if (this instanceof d && this._sId) {
        ...
        var j = this.doBeforeLoadData(m, l, n),
          k = this.get('paginator'),
          i = 0;
...
(function () {
  ...
  c.extend(h, g, {
      ...
      if (!n.width && !n.hidden) {
        ...
        if (p.offsetWidth !== k.offsetWidth) {
          ...
          var l = Math.max(
            0,
            m.offsetWidth -
              (parseInt(d.getStyle(m, 'paddingLeft'), 10) | 0) -
              (parseInt(d.getStyle(m, 'paddingRight'), 10) | 0),
            n.minWidth
          );
          var o = 'visible';
            ...
            if (!s.width && !s.hidden) {
              ...
              if (n.offsetWidth !== t.offsetWidth) {
                ...
                var p = Math.max(
                  0,
                  v.offsetWidth -
                    (parseInt(d.getStyle(v, 'paddingLeft'), 10) | 0) -
                    (parseInt(d.getStyle(v, 'paddingRight'), 10) | 0),
                  s.minWidth
                );
                var x = 'visible';
    ...
    _syncScrollY: function () {
      var k = this._elTbody,
        l = this._elBdContainer;
      if (!this.get('width')) {
        this._elContainer.style.width =
          l.scrollHeight > l.clientHeight
            ? k.parentNode.clientWidth + 19 + 'px'
            : k.parentNode.clientWidth + 2 + 'px';
      }
    },
      ...
      if (!this.get('height') && a.ie) {
        l.style.height =
          l.scrollWidth > l.offsetWidth
            ? k.parentNode.offsetHeight + 18 + 'px'
            : k.parentNode.offsetHeight + 'px';
      }
      if (this._elTbody.rows.length === 0) {
    ...
    _setOverhangValue: function (n) {
      var p = this._oColumnSet.headers[this._oColumnSet.headers.length - 1] || [],
        l = p.length,
        k = this._sId + '-fixedth-',
        o = n + 'px solid ' + this.get('COLOR_COLUMNFILLER');
...
(function () {
  ...
  a.prototype = {
    ...
    _initContainerEl: function () {
      ...
      j.tabIndex = 0;
      this.className = c.isArray(this.className)
        ? this.className
        : this.className
        ? [this.className]
        : [];
      ...
      if (c.isArray(this.checkboxOptions)) {
        ...
        for (m = 0, k = this.checkboxOptions.length; m < k; m++) {
          ...
          this.getContainerEl().innerHTML +=
            '<input type="checkbox"' + ' id="' + q + '"' + ' value="' + o + '" />';
