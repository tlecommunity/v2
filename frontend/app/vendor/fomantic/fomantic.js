      ...
      module = {
          ...
          popup: function () {
            ...
            if (!$container.length) {
              ...
              var $activatorParent = $activator.parent(),
                domPositionFunction =
                  $activatorParent.closest(selector.append).length !== 0 ? 'appendTo' : 'prependTo';
              $container = $('<div/>')
                  ...
                  if (disabled) {
                    ...
                    if (disabledDate !== null && disabledDate[metadata.message]) {
                      ...
                      if (
                        ...
                        (isInverted && disabledDate[metadata.inverted] === undefined)
                      ) {
                    ...
                    if (eventDate !== null) {
                      ...
                      if (eventDate[metadata.message]) {
                        ...
                        if (
                          ...
                          (isInverted && eventDate[metadata.inverted] === undefined)
                        ) {
                          cell.attr('data-inverted', '');
                        }
        ...
        refreshTooltips: function () {
          ...
          $container.find('td[data-position]').each(function () {
            ...
            var calcPosition =
              winWidth - cell.width() - (parseInt(tooltipWidth, 10) || 250) > cell.offset().left
                ? 'right'
                : 'left';
        ...
        helper: {
          isDisabled: function (date, mode) {
            return (
              ...
              ((mode === 'day' && settings.disabledDaysOfWeek.indexOf(date.getDay()) !== -1) ||
      ...
      date: function (text, settings) {
        ...
        text =
          settings.monthFirst || !text.match(/^[0-9]{1,2}[\/\-\.]/)
            ? text
            : text.replace(/[\/\-\.]/g, '/').replace(/([0-9]+)\/([0-9]+)/, '$2/$1');
        ...
        event: {
          ...
          keydown: function (event) {
            ...
            if (key == keyCode.escape) {
              ...
              !event.ctrlKey &&
              (key == keyCode.space || (key == keyCode.enter && settings.enableEnterKey))
            ) {
        ...
        get: {
          ...
          duration: function () {
            if (module.is.active()) {
              ...
              return (
                settings.transition.showDuration || settings.duration.show || settings.duration
              );
            }
          },
        },
          ...
          search: {
            focus: function (event) {
              ...
              if (
                !focused &&
                !module.is.active() &&
                (settings.showOnFocus || (event.type !== 'focus' && event.type !== 'focusin'))
              ) {
                focused = true;
                module.search();
              }
        ...
        determine: {
          ...
          eventOnElement: function (event, callback) {
            var $target = $(event.target),
              ...
              notOnLabel =
                $module.find($label).length === 0 || !(module.is.multiple() && settings.useLabels),
        ...
        get: {
          ...
          choiceValue: function ($choice, choiceText) {
            ...
            return $choice.data(metadata.value) !== undefined
              ...
              ? String(settings.ignoreSearchCase ? choiceText.toLowerCase() : choiceText).trim()
              : String(choiceText);
          },
          inputEvent: function () {
            var input = $search[0];
          ...
          selectValues: function () {
            ...
            $module.find('option').each(function () {
              var $option = $(this),
                ...
                text =
                  $option.data(metadata.text) !== undefined ? $option.data(metadata.text) : name,
              ...
              $removedLabel = $labels.filter(
                '[data-' +
                  ...
                  module.escape.string(
                    settings.ignoreCase ? escapedValue.toLowerCase() : escapedValue
                  ) +
                  '"]'
              );
      ...
      $.each(values, function (index, option) {
        ...
        if (itemType === 'item' || isMenu) {
          ...
          html +=
            ...
            (option[fields.class] ? deQuote(option[fields.class]) : className.item) +
            '" data-value="' +
          ...
          if (option[fields.image]) {
            html +=
              '<img class="' +
              (option[fields.imageClass] ? deQuote(option[fields.imageClass]) : className.image) +
              '" src="' +
          ...
          if (option[fields.icon]) {
            html +=
              ...
              ' ' +
              (option[fields.iconClass] ? deQuote(option[fields.iconClass]) : className.icon) +
              '"></i>';
          }
          if (hasDescription) {
            html +=
          ...
          if (groupName !== '' || groupIcon !== '') {
            html +=
              '<div class="' +
              (option[fields.class] ? deQuote(option[fields.class]) : className.header) +
              '">';
            if (groupIcon !== '') {
              html +=
                '<i class="' +
      ...
      module = {
          ...
          if (module.has.configActions()) {
            ...
            settings.actions.forEach(function (el) {
              var icon = el[fields.icon]
                  ? '<i class="' + module.helpers.deQuote(el[fields.icon]) + ' icon"></i>'
                  : '',
        ...
        event: {
          ...
          mousedown: function (event) {
            ...
            initialMouseDownInScrollbar =
              module.is.scrolling() &&
              ((!isRtl && $(window).outerWidth() - settings.scrollbarWidth <= event.clientX) ||
          ...
          safari: function () {
            if (module.cache.isSafari === undefined) {
              module.cache.isSafari =
                /constructor/i.test(window.HTMLElement) || !!window.ApplePaySession;
            }
              ...
              $module.css({
                top:
                  !$module.hasClass('aligned') && canFit
                    ...
                    : $(document).scrollTop() +
                      (module.cache.contextHeight - module.cache.height - settings.padding),
            ...
            if (isMultipleValues && sumTotal > module.total) {
              ...
              if (hasTotal) {
                module.value = percents.map(function (percent) {
                  return autoPrecision > 0
                    ? Math.round((percent / 100) * module.total * (10 * autoPrecision)) /
                        (10 * autoPrecision)
          ...
          label: function (value) {
            ...
            switch (settings.labelType) {
              case settings.labelTypes.number:
                return (
                  Math.round(
                    (value * (module.get.step() === 0 ? 1 : module.get.step()) + module.get.min()) *
                      precision
                  ) / precision
                );
          ...
          object: function (searchTerm, source, searchFields) {
            ...
            $.each(searchFields, function (index, field) {
              $.each(source, function (label, content) {
                var fieldExists =
                  typeof content[field] == 'string' || typeof content[field] == 'number';
                if (fieldExists) {
                  var text;
        ...
        is: {
          ...
          rtl: function () {
            if (module.cache.rtl === undefined) {
              module.cache.rtl =
                $module.attr('dir') === 'rtl' || $module.css('direction') === 'rtl';
            }
        ...
        get: {
          ...
          defaultPath: function (tabPath) {
            var $defaultNav = $allModules
                .filter('[data-' + metadata.tab + '^="' + module.escape.string(tabPath) + '/"]')
                .eq(0),
          ...
          navElement: function (tabPath) {
            ...
            return $allModules.filter(
              '[data-' + metadata.tab + '="' + module.escape.string(tabPath) + '"]'
            );
          },
          tabElement: function (tabPath) {
            ...
            $simplePathTab = $tabs.filter(
              '[data-' + metadata.tab + '="' + module.escape.string(lastTab) + '"]'
            );
  ...
  $.fn.toast = function (parameters) {
    ...
    $allModules.each(function () {
      var settings = $.isPlainObject(parameters)
        ...
        $context = settings.context ? $(settings.context) : $('body'),
        isToastComponent =
          $module.hasClass('toast') || $module.hasClass('message') || $module.hasClass('card'),
        element = this,
        ...
        initialize: function () {
          ...
          if (
            ...
            if (
              ...
              [className.top, className.bottom].indexOf(settings.showProgress) === -1
            ) {
        ...
        create: {
          ...
          toast: function () {
              ...
              if (settings.closeIcon) {
                $close = $('<i/>', {
                  class:
                    className.close +
                    ' ' +
                    (typeof settings.closeIcon === 'string' ? settings.closeIcon : ''),
                });
            ...
            if ($actions.length > 0 && !$actions.hasClass(className.attached)) {
              if (
                $actions &&
                (!$actions.hasClass(className.basic) || $actions.hasClass(className.left))
              ) {
            ...
            if (settings.displayTime === 'auto') {
              settings.displayTime = Math.max(
                ...
                ($toast.text().split(' ').length / settings.wordsPerMinute) * 60000
              );
            }
            ...
            if (settings.displayTime > 0) {
              var progressingClass =
                className.progressing + ' ' + (settings.pauseOnHover ? className.pausable : '');
            ...
            return (
              $context.find(
                module.helpers.toClass(settings.position) +
                  selector.container +
                  (settings.horizontal ? module.helpers.toClass(className.horizontal) : '')
              ).length > 0
            );
          },
          toast: function () {
