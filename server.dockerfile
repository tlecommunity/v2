...
RUN cpanm --notest Plack::Middleware::SizeLimit
RUN cpanm --notest Plack::Middleware::LightProfile

WORKDIR /home/lacuna/server/bin

# just a couple settings that help us with debugging and such.
# TERM being set gets us less working, PERLLIB gets us
# "perl -ML -e..." working
ENV TERM=xterm PERLLIB=/home/lacuna/server/lib
