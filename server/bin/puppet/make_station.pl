...
our $quiet;
  ...
  $body->update;
  $body->tick;
  $body->set_stored('energy', $body->get_capacity('energy'));
  $body->set_stored('water', $body->get_capacity('water'));
  $body->set_stored('pie', $body->get_capacity('food'));
  $body->set_stored('magnetite', $body->get_capacity('ore'));
  $body->needs_surface_refresh(1);
  $body->needs_recalc(1);
  $body->update;
