package UnitTestsFor::Lacuna::DB::Result::Map::Body::Planet;
...
use Lacuna::DB::Result::Map::Body::Planet;
...
sub test_construction {
    ...
    my $ws_user = Lacuna::DB::Result::Map::Body::Planet->new;
    isa_ok($ws_user, 'Lacuna::DB::Result::Map::Body');
}
