package UnitTestsFor::Lacuna::WebSocket::Starmap;
...
sub test_construction {
    ...
    my $ws_user = Lacuna::WebSocket::Starmap->new;
    isa_ok($ws_user, 'Lacuna::WebSocket::Starmap');
}
