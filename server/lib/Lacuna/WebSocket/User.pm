...
sub on_connect {
    ...
    return {
        message     => 'Welcome to Lacuna User server',
    };
}
sub log {
    my ($self) = @_;
...
sub ws_loginWithEmailCode {
    ...
    my $email_code = Lacuna::EmailCode->new({
