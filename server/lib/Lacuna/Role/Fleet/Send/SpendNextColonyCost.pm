...
after can_send_to_target => sub {
    ...
    confess [ 1011, 'You do not have enough happiness to colonize another planet. You need '.$next_colony_cost.' happiness.', [$next_colony_cost]] unless ( $self->body->get_stored('happiness') > $next_colony_cost);
    return 1;
};
