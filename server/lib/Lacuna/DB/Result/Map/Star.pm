...
__PACKAGE__->has_many('probes', 'Lacuna::DB::Result::Probe', 'star_id');
__PACKAGE__->has_many('laws', 'Lacuna::DB::Result::Law', 'star_id');
__PACKAGE__->belongs_to('station', 'Lacuna::DB::Result::Map::Body', 'station_id', { on_delete => 'set null' });
__PACKAGE__->has_many('bhgneut_laws', 'Lacuna::DB::Result::Law', sub {
    my $args = shift;
    return (
            {
