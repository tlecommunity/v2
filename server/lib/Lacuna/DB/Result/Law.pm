...
__PACKAGE__->typecast_map(type => {
    ...
    BHGPassport             => 'Lacuna::DB::Result::Law::BHGPassport',
    MembersOnlyColonization => 'Lacuna::DB::Result::Law::MembersOnlyColonization',
    MembersOnlyStations     => 'Lacuna::DB::Result::Law::MembersOnlyStations',
    MembersOnlyMiningRights => 'Lacuna::DB::Result::Law::MembersOnlyMiningRights',
    MembersOnlyExcavation   => 'Lacuna::DB::Result::Law::MembersOnlyExcavation',
